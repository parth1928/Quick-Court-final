// TypeScript version - run with: npx tsx scripts/test-admin-integration.ts
const { connectDB } = require('../lib/db.ts');
const { createAdminUser, getAdminWithProfile } = require('../lib/admin-utils.ts');
...
async function testAdminSystem() {
  try {
    ...
    // Test 3: Test API endpoints (simulate requests)
